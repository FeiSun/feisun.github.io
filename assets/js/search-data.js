...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-joined-the-editorial-board-of-tmlr-as-an-action-editor",
          title: 'Joined the Editorial Board of TMLR as an Action Editor.',
          description: "",
          section: "News",},{id: "news-two-papers-are-accepted-by-cikm-2026-congrats-to-yunfan-and-weiqiu",
          title: 'Two papers are accepted by CIKM 2026. Congrats to Yunfan and Weiqiu.',
          description: "",
          ...
          description: "",
          section: "People",handler: () => {
              window.location.href = "/people/0tangjing/";
